/*
  ==============================================================================
    ...
    BaseKeyboardComponent.h
    Created: 26 Jan 2021 1:27:40am
    Author:  Maaz
...
// This is copied over from the JUCE modules by customized for the needs of this plugin
...
class  BaseKeyboardComponent  : public Component,
...
public:
    ...
    /** Creates a BaseKeyboardComponent.
     ...
     */
    BaseKeyboardComponent (MidiKeyboardState& state,
                           Orientation orientation);
    
    /** Destructor. */
    ~BaseKeyboardComponent() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BaseKeyboardComponent)
};
